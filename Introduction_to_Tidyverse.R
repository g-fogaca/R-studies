...
# continent and size representing population, faceted by year
ggplot(gapminder, 
...
# Filter for 1957 then summarize the median life expectancy and the 
...
# Create a line plot showing the change in medianGdpPercap by continent
# over time
ggplot(by_year_continent,
       aes(x=year, y=medianGdpPercap, color=continent)) +
  geom_line() +
